var draw = {
    ...
    initEventListener: function() {
        document.querySelector('.configuration').addEventListener('submit', function(e){
            e.preventDefault();
            document.getElementById('invader').innerHTML = '';
            console.log(draw.gridSize.value)
            draw.drawGrid();
        })
        
        // Listener sur le click pour changer la couleur
        document.querySelector('#invader').addEventListener('mousedown', function handleclick(e){
        ...
        document.querySelector('.colorSelector').addEventListener('mousedown', function handleclick(e){
        ...
        document.querySelector('#invader').addEventListener('mouseover', function handleclick(e){
        ...
        document.querySelector('#invader').addEventListener('mouseout', function handleclick(e){
            if(draw.clicked===true){
            }else{
        ...
        document.querySelector('#invader').addEventListener('mouseup', function handleclick(e){
            draw.clicked = false;
            console.log(draw.clicked)
        });
    }
